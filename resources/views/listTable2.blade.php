                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg dark:border-gray-200">
                        ...
                        {{-- <form action="/table-2/cari" method="GET">   
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="cari" placeholder="Cari Data .." value="{{ old('cari2') }}" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." required>
